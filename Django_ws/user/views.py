...
def student_auth(request):
    non_target = ['국어교육과', '지리교육과', '수학교육과', '체육교육과', '컴퓨터교육과', '영어교육과', '역사교육과', '트리니티자유-반려동물학', '트리니티자유-군사학', '트리니티융합-의료경영학', '트리니티융합-바이오메디컬', '트리니티융합-디지털헬스케어', '트리니티융합-행정학', '트리니티융합-사회복지학', '트리니티융합-경영학', '트리니티융합-광고홍보학', '트리니티융합-호텔경영학', '트리니티융합-조리외식경영학', '트리니티융합-스포츠레저학', '트리니티융합-스포츠건강관리학', '트리니티융합-스포츠지도학', '트리니티융합-항공교통물류', '트리니티융합-항공운항', '트리니티융합-항공정비학', '트리니티융합-스마트항만공학', '트리니티융합-건축학', '트리니티융합-건축공학', '트리니티융합-실용음악', '트리니티융합-콘텐츠제작', '트리니티융합-CG디자인', '자율전공학부', '트리니티융합-호텔관광경영학', '트리니티융합-스포츠재활의학']
    data = request.data
